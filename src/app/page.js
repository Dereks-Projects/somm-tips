...
/*
  ...
  - Hero tagline: "What are you in the mood for today?"
  ...
  No logic here — just navigation cards routing to subpages.
*/

const secondaryCards = [
  {
    title: "Classic Pairings",
    desc: "Timeless food & wine combinations",
      ...
      <section className={styles.primarySection}>
        <Link href="/wine-recommendations" className={styles.primaryCard}>
          <div className={styles.primaryContent}>
            ...
            <h2 className={styles.primaryTitle}>Wine Recommendations</h2>
            <p className={styles.primaryDesc}>
              Find the perfect wine for you right here.
            </p>
          </div>
